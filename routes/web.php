...
Route::group(['prefix' => '/'], function () {
    Route::get('/',['as'=>'admin.getLogin','uses'=>'UserController@getLogin']);
    Route::post('/',['as'=>'admin.postLogin','uses'=>'UserController@postLogin']);
...
Route::group(['middleware' => ['login']], function () {
    Route::get('/home',['as'=>'index','uses'=>'PagesController@index']);
